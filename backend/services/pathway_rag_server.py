...
def main():
    ...
    rag_app = BaseRAGQuestionAnswerer(
        ...
        prompt_template=(
            ...
            "   - Cite sources using numbered brackets like [1], [2] corresponding to the order of documents provided in the context.\n"
            ...
            "   - Only include information from relevant sources.\n"
            "   - If no relevant sources exist for a question, say \"I couldn't find specific information about that in your documents\"\n\n"
            "4. **Citation Format**:\n"
            "   - Use ONLY [1], [2], etc. Do not include page numbers or filenames in the text.\n"
            "   - Do NOT generate JSON or metadata in the response text.\n\n"
